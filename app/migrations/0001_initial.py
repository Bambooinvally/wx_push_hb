...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', primary_key=True, serialize=False, auto_created=True)),
                ('openId', models.CharField(verbose_name='微信的openid', max_length=255)),
                ('name', models.CharField(max_length=100, blank=True, null=True)),
                ('phone', models.CharField(max_length=100, blank=True, null=True)),
                ('address', models.CharField(max_length=255, blank=True, null=True)),
                ('createTime', models.DateTimeField(default=datetime.datetime(2020, 3, 20, 22, 31, 26, 719618))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(max_length=100, blank=True, null=True)),
                ('address', models.CharField(max_length=255, blank=True, null=True)),
                ('createTime', models.DateTimeField(default=datetime.datetime(2020, 3, 20, 22, 31, 26, 720618))),
                ('IDcard', models.CharField(verbose_name='注册时的身份证', max_length=255, blank=True, null=True)),
                ('extraInfo', models.CharField(max_length=255, blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(max_length=100, blank=True, null=True)),
                ('address', models.CharField(max_length=255, blank=True, null=True)),
                ('createTime', models.DateTimeField(default=datetime.datetime(2020, 3, 20, 22, 31, 26, 718618))),
                ('IDcard', models.CharField(verbose_name='注册时的身份证', max_length=255, blank=True, null=True)),
                ('extraInfo', models.CharField(max_length=255, blank=True, null=True)),
                ('ammeter', models.ManyToManyField(to='app.Ammeters')),
            ],
